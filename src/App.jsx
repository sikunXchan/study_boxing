...
function App() {
  ...
  const renderContent = () => {
    switch (activeTab) {
      ...
      case 'guild': return <GuildArea resources={resources} stats={stats} setStats={setStats} setResources={setResources} inventory={inventory} setInventory={setInventory} equippedItems={equippedItems} facilities={facilities} setFacilities={setFacilities} badHabits={badHabits} setBadHabits={setBadHabits} reincarnationCount={reincarnationCount} />;
